...
begin
  ...
  begin
    Application.MessageBox('Введите трудоемкость решения!', 'Ошибка',
  ...
  Try
    ...
    Close;
    Application.MessageBox(PWideChar('Решение по заявке "№'+
      Form2.ADOQueryRequisitions.FieldByName('Номер').AsString + ' от '+
      Form2.ADOQueryRequisitions.FieldByName('Дата регистрации').AsString +'" успешно зафиксировано'),
