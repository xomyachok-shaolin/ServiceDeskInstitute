...
begin
  ...
  ADOStoredProc1.Parameters.Items[0].Value := Form2.ADOQueryServices.FieldByName('Наименование').AsString;
  ...
  Close;
  Application.MessageBox('Услуга успешно отредактирована', 'Транзакция выполнена', MB_OK or MB_ICONINFORMATION);
