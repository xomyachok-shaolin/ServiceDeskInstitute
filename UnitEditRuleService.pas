...
begin
  ...
  ADOStoredProc1.Parameters.Items[0].Value := Form2.ADOQueryServiceCathegoryRules.FieldByName('ИД Правила').AsString;

  ADOStoredProc1.Parameters.Items[1].Value := Form2.ADOQueryServices.FieldByName('Наименование').AsString;
  ...
  Close;
  Application.MessageBox('Норматив успешно отредактирован', 'Транзакция выполнена', MB_OK or MB_ICONINFORMATION);
