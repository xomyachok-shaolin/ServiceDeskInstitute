object Form12: TForm12
  ...
  Caption = #1060#1086#1088#1084#1072' '#1088#1077#1075#1080#1089#1090#1088#1072#1094#1080#1080' '#1087#1088#1072#1074#1080#1083#1072' '#1087#1088#1077#1076#1086#1089#1090#1072#1074#1083#1077#1085#1080#1103' '#1091#1089#1083#1091#1075#1080
  ClientHeight = 366
  ClientWidth = 657
  Color = clBtnFace
  ...
  object ADOStoredProc1: TADOStoredProc
    ...
    ProcedureName = 'MASS_19.'#1050#1055'_'#1059#1063#1045#1058'_'#1059#1057#1051#1059#1043'_'#1048'_'#1053#1054#1056#1052#1040#1058#1048#1042#1054#1042'.'#1056#1045#1043'_'#1055#1056#1040#1042#1048#1051#1040'_'#1055#1056#1045#1044'_'#1059#1057#1051#1059#1043#1048
    Parameters = <>
    Left = 387
    Top = 312
  end
  object ADOQueryServiceCathegoryRules: TADOQuery
    ...
    SQL.Strings = (
        ...
        'm '#1050#1055'_'#1050#1040#1058#1040#1051#1054#1043'_'#1059#1057#1051#1059#1043' where "'#1048#1044' '#1055#1088#1072#1074#1080#1083#1072'" is not null')
    Left = 531
    Top = 106
  end
end
